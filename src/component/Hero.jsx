...
export function Hero(){
    return(
        <section className='md:grid md:grid-cols-2 md:w-[80%] md:mx-auto md:items-center md:justify-center md:h-[80vh] md:gap-5'>
            <div className='grid gap-4 md:gap-10'>
                <img src={heroImage} alt="product-image-1" className='md:rounded-lg md:w-5/6'/>
                <div className='relative bottom-[13em] flex justify-between px-3 md:hidden'>
                ...
                <div className='hidden md:flex md:gap-8'>
                    <div className='border-4 border-orange-400 rounded-lg'>
                        <img src={heroImage} alt="hero-image" width={80} className='rounded-lg opacity-25'/>
                    </div>
                    {/* <img src={heroImage} alt="hero-image" width={80} className='rounded-lg opacity-25 border-4 border-Orange'/> */}
                    <img src={productImage2} alt="product-image-2" width={80} className='rounded-lg'/>
                    <img src={productImage3} alt="product-image-2" width={80} className='rounded-lg'/>
                    <img src={productImage4} alt="product-image-2" width={80} className='rounded-lg'/>
                </div>
            </div>
            <div className='px-6 grid gap-6 mb-10 md:mb-0'>     
                ...
                <div className='grid gap-5'>
                    ...
                    <div className='grid gap-5 md:flex md:w-full'>
                        ...
                        <button className='md:w-full flex justify-center bg-Orange py-4 rounded-lg font-bold gap-2 shadow-2xl shadow-Orange/40'>
