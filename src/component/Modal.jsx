        ...
        <div className=' md:w-full fixed top-0 z-50 full h-[100vh] bg-Black hidden'>
            <div className='w-[80%] mx-auto md:w-full h-full flex flex-col gap-10 justify-center items-center'>
                <div className='md:w-96'>
                    <svg width="14" height="15" className='justify-self-end mb-2' xmlns="http://www.w3.org/2000/svg"><path d="m11.596.782 2.122 2.122L9.12 7.499l4.597 4.597-2.122 2.122L7 9.62l-4.595 4.597-2.122-2.122L4.878 7.5.282 2.904 2.404.782l4.595 4.596L11.596.782Z" fill="White" fillRule="evenodd" /></svg>
